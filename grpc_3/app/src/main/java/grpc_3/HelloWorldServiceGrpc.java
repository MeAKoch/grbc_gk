...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc_3.Hello.HelloRequest,
      grpc_3.Hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = grpc_3.Hello.HelloRequest.class,
      responseType = grpc_3.Hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc_3.Hello.HelloRequest,
      grpc_3.Hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<grpc_3.Hello.HelloRequest, grpc_3.Hello.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<grpc_3.Hello.HelloRequest, grpc_3.Hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc_3.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc_3.Hello.HelloResponse.getDefaultInstance()))
   ...
   */
  public static HelloWorldServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<HelloWorldServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<HelloWorldServiceBlockingV2Stub>() {
        @java.lang.Override
        public HelloWorldServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new HelloWorldServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return HelloWorldServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(grpc_3.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc_3.Hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceStub
    ...
    /**
     */
    public void hello(grpc_3.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc_3.Hello.HelloResponse> responseObserver) {
   ...
   */
  public static final class HelloWorldServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<HelloWorldServiceBlockingV2Stub> {
    private HelloWorldServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected HelloWorldServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new HelloWorldServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    /**
     */
    public grpc_3.Hello.HelloResponse hello(grpc_3.Hello.HelloRequest request) throws io.grpc.StatusException {
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service HelloWorldService.
   */
  public static final class HelloWorldServiceBlockingStub
    ...
    /**
     */
    public grpc_3.Hello.HelloResponse hello(grpc_3.Hello.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc_3.Hello.HelloResponse> hello(
        grpc_3.Hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((grpc_3.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc_3.Hello.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc_3.Hello.HelloRequest,
              grpc_3.Hello.HelloResponse>(
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc_3.Hello.getDescriptor();
    }
